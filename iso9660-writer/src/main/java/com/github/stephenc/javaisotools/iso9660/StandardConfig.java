...
public abstract class StandardConfig {
    ...
    /**
     * Returns active metadata files<br> Possibly including Publisher, Data Preparer and Application Identifier as well
     * as Abstract, Bibliographic and Copyright File
     *
